#ifndef __Drone_NAV_SLAM_sfun_h__
#define __Drone_NAV_SLAM_sfun_h__
...
extern mxArray* load_Drone_NAV_SLAM_optimization_info(boolean_T isRtwGen,
  boolean_T isModelRef, boolean_T isExternal);
extern void unload_Drone_NAV_SLAM_optimization_info(void);
