#ifndef __cameraudp_sfun_h__
#define __cameraudp_sfun_h__
...
extern mxArray* load_cameraudp_optimization_info(boolean_T isRtwGen, boolean_T
  isModelRef, boolean_T isExternal);
extern void unload_cameraudp_optimization_info(void);
